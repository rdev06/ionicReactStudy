import { IonItem, IonLabel, IonList, IonText, IonAvatar, IonThumbnail, IonButton, IonIcon, IonDatetime, IonSelect, IonSelectOption, IonToggle, IonInput, IonCheckbox, IonRange, IonNote } from '@ionic/react';
...
const Outbox: React.FC = () => {
  return (
      <BasicPage label='OutBox'>
        ...
        <IonItem detail={false} href="/page/Outbox">
          <IonLabel>
